<?php 
	const BASE_URL = "http://localhost/Turnero/";
  ...
  <body>
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <a href="<?= BASE_URL ?>views/inicio/" class="app-brand-link text-decoration-none">
        <span class="fw-bold text-primary fs-4">Sistemas de Gestión de Turnos</span>
        </a>
