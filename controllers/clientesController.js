var table = $("#TablaClientes").DataTable({
    ...
    ajax: {
        ...
        "url": "/Turnero/models/model_clientes.php",
    },
    "columns": [
        { "data": "numero" },
        { "data": "cliente" },
        ...
        { "data": "estado" },
        {
            ...
            "render": function(data, type, row) {
                return '<button class="btn btn-danger" onclick="EliminarCliente(' + row.numero + ')">Eliminar</button>';
            }
        }
    ]
});
                ...
                success: function(response) {
                    try {
                        if (response.codigo === 0) {
                            ...
                            Swal.fire({
                                title: 'Error!',
                                text: response.respuesta || 'No se pudo eliminar el cliente.',
                                icon: 'error',
                                showConfirmButton: false,
                                timer: 2000
                            });
